    ...
    public static void main(String[] args) throws IOException {
        ...
        for (i = 0; i < zipCodeState.size(); ++i) {
            ...
            if (zipCodeState.get(i).equals(myZipCode)) {
                //zipCodeState.get(i).printInfo();
                myState = zipCodeState.get(i).getValue2();
            }
        ...
        for (i = 0; i < abbrevState.size(); ++i) {
            ...
            if (abbrevState.get(i).equals(zipCodeState.get(myZipCode))) {
                stateAbbrev = abbrevState.get(i).getValue2();
            }
        }
